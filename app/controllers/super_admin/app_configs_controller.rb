class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      # PAGESPEED_API_KEY/SCANNER_URL/SCANNER_TOKEN sao fork-owned (SCAN v1, ver ScanService) --
      # colocados aqui por conveniencia, nao ha aba dedicada de Up Sales nesta tela ainda.
      'google' => %w[GOOGLE_OAUTH_CLIENT_ID GOOGLE_OAUTH_CLIENT_SECRET GOOGLE_OAUTH_REDIRECT_URI ENABLE_GOOGLE_OAUTH_LOGIN GOOGLE_PLACES_API_KEY
                      PAGESPEED_API_KEY SCANNER_URL SCANNER_TOKEN],
